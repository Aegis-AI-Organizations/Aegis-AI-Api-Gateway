...
const (
	...
	AgentService_ListAgents_FullMethodName            = "/aegis.v2.AgentService/ListAgents"
	AgentService_GetAgentStatusSummary_FullMethodName = "/aegis.v2.AgentService/GetAgentStatusSummary"
)
...
type AgentServiceClient interface {
	...
	GetAgentStatusSummary(ctx context.Context, in *GetAgentStatusSummaryRequest, opts ...grpc.CallOption) (*GetAgentStatusSummaryResponse, error)
}
...
func (c *agentServiceClient) GetAgentStatusSummary(ctx context.Context, in *GetAgentStatusSummaryRequest, opts ...grpc.CallOption) (*GetAgentStatusSummaryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAgentStatusSummaryResponse)
	err := c.cc.Invoke(ctx, AgentService_GetAgentStatusSummary_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AgentServiceServer interface {
	...
	// GetAgentStatusSummary returns aggregated agent status counters for a company.
	GetAgentStatusSummary(context.Context, *GetAgentStatusSummaryRequest) (*GetAgentStatusSummaryResponse, error)
...
func (UnimplementedAgentServiceServer) GetAgentStatusSummary(context.Context, *GetAgentStatusSummaryRequest) (*GetAgentStatusSummaryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAgentStatusSummary not implemented")
}
...
func _AgentService_GetAgentStatusSummary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAgentStatusSummaryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AgentServiceServer).GetAgentStatusSummary(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AgentService_GetAgentStatusSummary_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AgentServiceServer).GetAgentStatusSummary(ctx, req.(*GetAgentStatusSummaryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AgentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAgentStatusSummary",
			Handler:    _AgentService_GetAgentStatusSummary_Handler,
		},
	},
