...
type GetScanStatusResponse struct {
	...
	CrewReportJson     string                 `protobuf:"bytes,8,opt,name=crew_report_json,json=crewReportJson,proto3" json:"crew_report_json,omitempty"`
	CrewReportMarkdown string                 `protobuf:"bytes,9,opt,name=crew_report_markdown,json=crewReportMarkdown,proto3" json:"crew_report_markdown,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *GetScanStatusResponse) GetCrewReportJson() string {
	if x != nil {
		return x.CrewReportJson
	}
	return ""
}

func (x *GetScanStatusResponse) GetCrewReportMarkdown() string {
	if x != nil {
		return x.CrewReportMarkdown
	}
	return ""
}
...
const file_aegis_v2_scan_proto_rawDesc = "" +
	...
	"\ascan_id\x18\x01 \x01(\tR\x06scanId\"\x96\x03\n" +
	...
	"\x10crew_report_json\x18\b \x01(\tR\x0ecrewReportJson\x120\n" +
	"\x14crew_report_markdown\x18\t \x01(\tR\x12crewReportMarkdown\"\x12\n" +
